...
public class vehiclecontroller {
	...
	public void createBike() throws Exception {
		...
		try {
			Wheel r1 = new Wheel(marcaRodaTrasera, Double.parseDouble(diametreRodaTrasera));
			Wheel r2 = new Wheel(marcaRodaDavantera, Double.parseDouble(diametreRodaDavantera));
